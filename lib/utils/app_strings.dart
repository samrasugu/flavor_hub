const String appName = 'Flavor Hub';

// button texts
const String readMore = 'Read More';

const String learnHowTobecomeChef =
    'Learn how to become a master chef right now!';

const String recentRecipes = 'Recent Recipes';
const String yourRecipes = 'Your Recipes';
const String favoriteRecipes = 'Favorite Recipes';
