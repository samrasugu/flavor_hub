...
SizedBox size40HorizontalSizedBox = const SizedBox(width: 40);
SizedBox veryLargeHorizontalSizedBox = const SizedBox(width: 50);
SizedBox extremelyLargeHorizontalSizedBox = const SizedBox(width: 60);
SizedBox size70HorizontalSizedBox = const SizedBox(width: 70);
SizedBox size100HorizontalSizedBox = const SizedBox(width: 100);
SizedBox size120HorizontalSizedBox = const SizedBox(width: 120);
